...
<Flex center class="absolute z-1 transition-all duration-300 top-[30vh] {isVisible ? '-left-18.25' : 'left-0'}">
	<Flex column class="w-18">
		<Flex class="w-full bg-tertiary shadow-[1px_0px_black,0px_-1px_black] border-t-2 border-r-2 border-solid border-bright-primary rounded-tr-full h-9" />
		<Flex center column class="bg-tertiary border-r-2 border-solid border-bright-primary shadow-[1px_0px_black] gap-2">
			...
			<Button 
				...
				class="hover:-translate-y-0.5 hover:drop-shadow-[0px_2px_black] w-13 border-[3px] outline-black outline-2 rounded-full border-solid overflow-hidden border-bright-primary bg-tertiary h-13 relative" center>
				<AvatarImage class="absolute -bottom-4" headOnly figure={ userLook }/>
			</Button>
		</Flex>
		<Flex class="w-full bg-tertiary shadow-[1px_0px_black,0px_1px_black] border-b-2 border-r-2 border-solid border-bright-primary rounded-br-full h-9" />
	</Flex>
	<Button 
