...
<Flex center class="absolute z-1 transition-all duration-300 top-[30vh] {isVisible ? '-left-18.25' : 'left-0'}">
	<Flex column class="w-18">
		...
		<Flex center column class="bg-default-primary border-r-2 border-solid border-default-hover shadow-[1px_0px_black] gap-2">
			...
			<Button 
				...
				class="hover:-translate-y-0.5 hover:drop-shadow-[0px_2px_black] w-13 border-[3px] outline-black outline-2 rounded-full border-solid overflow-hidden border-default-hover bg-default-primary h-13 relative" center>
	...
	<Button 
		class="shadow-[1px_0px_black,0px_-1px_black,0px_1px_black] px-1.5 right-0.5 rounded-r-md border-2 border-l-0 border-solid border-default-hover relative bg-default-primary h-15" 
