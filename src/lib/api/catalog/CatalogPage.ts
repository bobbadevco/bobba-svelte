import type { ICatalogPage, IPageLocalization, IPurchasableOffer } from '$lib/api';
...
export class CatalogPage implements ICatalogPage
{
	...
	private readonly _layoutCode: string;
	private readonly _localization: IPageLocalization;
	private readonly _offers: IPurchasableOffer[];
	private readonly _acceptSeasonCurrencyAsCredits: boolean;
