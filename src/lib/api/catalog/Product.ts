import type { IFurnitureData, IObjectData, IProductData } from '@nitrots/nitro-renderer';
import  { GetConfiguration, GetRoomEngine, GetSessionDataManager, type IProduct, type IPurchasableOffer, ProductTypeEnum } from '$lib/api';
import { GetPixelEffectIcon, GetSubscriptionProductIcon } from '$lib/api/catalog/CatalogUtils';
...
export class Product implements IProduct
{
	...
	private readonly _productClassId: number;
	private _extraParam: string;
	private readonly _productCount: number;
	private readonly _productData: IProductData;
	private readonly _furnitureData: IFurnitureData;
	private readonly _isUniqueLimitedItem: boolean;
	private readonly _uniqueLimitedItemSeriesSize: number;
	...
	public getIconUrl(offer?: IPurchasableOffer): string | undefined
	{
