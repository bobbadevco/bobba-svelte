import { GetRoomEngine, type ICatalogNode } from '$lib/api';
import type { SellablePetPaletteData } from '@nitrots/nitro-renderer';

export const GetPixelEffectIcon = (_id: number) =>
{
	return '';
}

export const GetSubscriptionProductIcon = (_id: number) =>
{
	return '';
}
